...
var Previewer = /** @class */ (function () {
    ...
    Previewer.prototype.attach = function (editor) { };
    return Previewer;
}());
...
var TheEditor = /** @class */ (function () {
    ...
    function TheEditor(host, options) {
        ...
        var opts = __assign(__assign({}, TheEditor.defaultOptions), options);
        this.codemirrorEditor = codemirror(host, {
            mode: opts.gfm ? 'gfm' : 'markdown',
            lineNumbers: opts === null || opts === void 0 ? void 0 : opts.lineNumbers,
            tabSize: opts === null || opts === void 0 ? void 0 : opts.tabSize,
            indentWithTabs: true,
            lineWrapping: true,
            foldGutter: opts === null || opts === void 0 ? void 0 : opts.lineNumbers,
            gutters: (opts === null || opts === void 0 ? void 0 : opts.lineNumbers) ? ['CodeMirror-linenumbers', 'CodeMirror-foldgutter'] : [],
            value: (opts === null || opts === void 0 ? void 0 : opts.value) || ''
        });
        var previewer = new Previewer();
        previewer.attach(this);
    }
    /**
     * 设置markdown内容
     * @param markdown markdown文本
     */
    TheEditor.prototype.setMarkdown = function (markdown) {
        this.codemirrorEditor.setValue(markdown);
    };
    /**
     * 获取markdown内容
     */
    TheEditor.prototype.getMarkdown = function () {
